            ...
            <div className='mt-8'>
                ...
                <div className='mt-8'>
                    ...
                    <div className='grid grid-cols-2 gap-3 mt-2'>
                        <button className='flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-500 hover:bg-gray-50'> 
                        <svg
                            className="w-5 h-5"
                            aria-hidden="true"
                            fill="currentColor"
